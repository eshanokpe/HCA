          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">List Of Nurse's</h6>
              </div>
            </div>
            @if (session('success'))
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <div class="d-flex flex-column justify-content-center text-end pe-4">
                            ...
                            <a href="{{route('admin.createnurse')}}" class="btn btn-primary"> <i class="fas fa-user-nurse"></i> +Add Nurse</p></a>
                        </div>
                    <tr>
                  ...
                  @foreach ($nurses as $nurse)
                    <tr>
                      ...
                      <td>
                        <div class="d-flex flex-column justify-content-center text-center">
                            <p class="text-xs font-weight-bold mb-0">{{ $nurse->username }}</p>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex flex-column justify-content-center text-center">
                            <p class="text-xs font-weight-bold mb-0">{{ $nurse->fullname  }}</p>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex flex-column justify-content-center text-center">
                            <p class="text-xs font-weight-bold mb-0">{{ $nurse->email }}</p>
                        <div class="d-flex flex-column justify-content-center">
                      </td>
                      <td>
                        <div class="d-flex flex-column justify-content-center text-center">
                            <p class="text-xs font-weight-bold mb-0">{{ $nurse->shift }}</p>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex flex-column justify-content-center text-center">
                            <p class="text-xs font-weight-bold mb-0">{{ $nurse->created_at }}</p>
                        </div>
                      </td>
